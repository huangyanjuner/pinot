...
public class SumStarTreeIndexTest extends BaseStarTreeIndexTest {
  ...
  protected Map<List<Integer>, List<Double>> compute(Operator filterOperator) {
    ...
    Map<List<Integer>, List<Double>> result = new HashMap<>();
    int docId;
  ...
  @Test
  public void testStarTree() throws Exception {
    IndexLoadingConfig indexLoadingConfig = new IndexLoadingConfig();
    indexLoadingConfig.setStarTreeVersion(StarTreeFormatVersion.ON_HEAP);
    _segment = ColumnarSegmentLoader.load(_onHeapIndexDir, indexLoadingConfig);
  ...
  private void compareMetadata(StarTreeInterf onHeapStarTree, StarTreeInterf offHeapStarTree) {
    ...
    HashBiMap<String, Integer> onHeapDimensionNameToIndexMap = onHeapStarTree.getDimensionNameToIndexMap();
    HashBiMap<String, Integer> offHeapDimensionNameToIndexMap = offHeapStarTree.getDimensionNameToIndexMap();
    Assert.assertEquals(offHeapDimensionNameToIndexMap, onHeapDimensionNameToIndexMap,
